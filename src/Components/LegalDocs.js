    ...
    <div className="legal-section-title">
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Cure Point, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using Cure Point, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          Cure Point is designed to simplify healthcare access. You can choose
      ...
      <div className="legal-footer">
        <p>© 2013-2023 Cure. All rights reserved.</p>
      </div>
    </div>
  );
}
